...
export default function Input() {
    return (
        <div className={styles.input}>
            <input type="text" placeholder="  Type a daily note..." />
            <button><div className={styles.circle}><svg width="19" height="16" viewBox="0 0 19 16" fill="none" xmlns="http://www.w3.org/2000/svg">
